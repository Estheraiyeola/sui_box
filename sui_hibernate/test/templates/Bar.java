...
/**
* Auto-generated bridge for on-chain struct `Bar`.
*/
@AutoGeneratedModel(structName="Bar")
public class Bar {
    ...
    private Bar(String objectId, SuiContractManager mgr) {
    ...
    public static CompletableFuture<Bar> create(
